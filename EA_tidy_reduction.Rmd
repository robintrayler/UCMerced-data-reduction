...
file_path <- '~/Box Sync/Data Repository/EA/EA20210928.csv'
```
...
```{r}
# rejection criteria
small_peaks <- 1 # warn about peaks smaller with an amplitude smaller than this
...
drift_material = c('costech acetanilide', 'USGS 41a')
...
We thank Dr. Robin B. Trayler and the staff of the the Stable Isotope Ecosystems Laboratory of UC Merced for their assistance with stable isotope and elemental analysis.
