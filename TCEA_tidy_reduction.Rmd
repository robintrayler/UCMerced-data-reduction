...
file_path <- '~/Box Sync/Data Repository/TCEA/TCEA20210114.csv'
```
...
linearity_material =  c('USGS 80', 'USGS 81')
# material to use for drift corrections
drift_material = c('USGS 80', 'USGS 81')
# in house 'check' materials for run quality
check_material = c('EA Ag3PO4', 'IAEA 601', 'NIST 120C', 'alfa asar')
```
